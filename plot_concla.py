...
def plot_avg_confusion_matrix(folder="cla_results/concla/pu"):
    class_labels = ['1%C','3%C','5%C','7%C','9%C']
    ...
    output_filename = 'confusion_matrix.eps'
...
if __name__ == '__main__':
    ...
    for s_name in solutes:
        real_folder = os.path.join(root_dir, s_name)
        plot_avg_confusion_matrix(folder=real_folder)